...
func _on_finish_pressed():
	...
	get_node("/root/Game/HUD/Money")._add_money(get_node("/root/Game/MainClient/Dialog/Text").money_payment)
	get_node("/root/Game/HUD/Reputation")._add_fame(get_node("/root/Game/MainClient/Dialog/Text").fame_payment)
