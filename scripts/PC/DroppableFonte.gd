...
func _can_drop_data(_at_position, data):
	if data["origin_texture"] == load("res://assets/DragDrop/PC-fonte.png"):
		return true
	else:
		return false
...
func _drop_data(_at_position, data):
	...
	get_node("/root/Game/MainPC/PC/DragDrop/Box").possible_parts.erase(load("res://assets/DragDrop/PC-fonte.png"))
