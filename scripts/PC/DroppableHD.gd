...
func _can_drop_data(_at_position, data):
	if data["origin_texture"] == load("res://assets/DragDrop/PC-hd.png"):
		get_node("/root/Game/MainPC/PC/DragDrop/Box").possible_parts.erase(load("res://assets/DragDrop/PC-hd.png"))
		return true
	else:
		return false
